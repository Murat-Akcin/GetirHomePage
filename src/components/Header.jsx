...
const Header = () => {
  return (
    <div className="bg-menu-color">
      <div className="container mx-auto h-11 px-32 flex items-center justify-between">
        <a href="*">
          <img
        ...
        <nav className="flex gap-x-12 text-sm font-semibold">
          <a
            className="text-white text-opacity-80 hover:text-opacity-100 flex gap-x-2 items-center "
            href="*"
          >
            <BiGlobe size={20} />
            Türkçe (TR)
